  ...
  public Coral1() {
    addCommands(
      new MoveElevatorToSetpointCommand(elevator, 
            EndEffectorSetpointConstants.EndEffectorSetpoints.CORAL_L1.elevatorSetpoint),
      new MoveWristToSetpoint(wrist, EndEffectorSetpointConstants.EndEffectorSetpoints.CORAL_L1.wristSetpoint)
      );
  }
}
