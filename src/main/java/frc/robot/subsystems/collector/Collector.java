...
public class Collector extends SubsystemBase {
  ...
  public Command chokeUpCommand(boolean stopOnEnd, Supplier<EndEffectorToSetpointConstants> endEffectorSetpoint) {
    int endCount[] = {0};
      return runEnd(
        () -> {
          if(!endEffectorSetpoint.get().equals(EndEffectorSetpointConstants.CORAL_GROUND) && !endEffectorSetpoint.get().equals(EndEffectorSetpointConstants.CORAL_STOW)) {
